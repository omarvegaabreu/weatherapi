          ...
          <div>
            ...
            <span className="weather-item">{this.state.sunset}</span>
            {
              this.state.moonImage ? (
                <img style={{height: "1.5rem", marginLeft: "1.5rem", marginRight: "1rem"}} src={this.state.moonImage} alt="moon phase" />
              ) : (null)
            }
